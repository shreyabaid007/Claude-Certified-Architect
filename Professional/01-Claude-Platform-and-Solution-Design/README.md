...
| [06-Reference-Architectures](06-Reference-Architectures.md) | The five reference architectures, when to compose them, and the retrieval-versus-tool-call principle |
| [07-RAG-Pipeline-Design](07-RAG-Pipeline-Design.md) | Chunking by corpus, indexing by query pattern, reciprocal rank fusion, and the three-way trade-off |
| [08-Model-Context-Window-and-Context-Strategy](08-Model-Context-Window-and-Context-Strategy.md) | Model-tier selection, the working-memory cliff, the four context strategies, extended thinking, and eval-gated model swaps |
| [09-Prompt-Architecture-and-Reuse](09-Prompt-Architecture-and-Reuse.md) | System-prompt structure, templates, Description and underspecification, caching mechanics, prompt library versus Skill |
| [10-Entry-Points-and-Interfaces](10-Entry-Points-and-Interfaces.md) | The five entry points, the four build-time interfaces, Claude Code's shaping and governing layers |
| [11-Delivery-Routes-and-Regulated-Constraints](11-Delivery-Routes-and-Regulated-Constraints.md) | The four delivery routes, what transfers across them, and the regulated-industry gate |

Not yet written: the third prompting screen.
...
| 03 | Can you name the reference architecture? | Recognize a known shape upfront and adapt it, or risk expensive pivots later | [Covered](06-Reference-Architectures.md), with [RAG depth](07-RAG-Pipeline-Design.md) |
| 04 | Where does your work interact with Claude? | Entry point, model, and context strategy that keep it working and cost-conscious | [Model and context](08-Model-Context-Window-and-Context-Strategy.md), [entry points](10-Entry-Points-and-Interfaces.md), and [delivery routes](11-Delivery-Routes-and-Regulated-Constraints.md) |
