...
> **The key:** The gate is part of the orchestration design, not bolted on afterward. Routing by stakes gets its full treatment later in the course.
...
**Source:** Claude Certified Architect Professional, Module 1 (Claude Platform & Solution Design), screen sets "Multi-agent systems and orchestration" and "When fan-out hid a dropped unit."
