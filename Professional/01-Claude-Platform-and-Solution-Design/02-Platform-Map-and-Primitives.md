...
> **Selection comes later:** This section is vocabulary. Choosing among these under real constraints is in [entry points and interfaces](10-Entry-Points-and-Interfaces.md) and [delivery routes](11-Delivery-Routes-and-Regulated-Constraints.md).
...
The full architecture teardown, including what the bank should have built instead, is in [entry points and interfaces](10-Entry-Points-and-Interfaces.md#case-study-when-claude-code-got-picked-outside-engineering).
